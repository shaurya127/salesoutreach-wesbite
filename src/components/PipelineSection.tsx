...
const icons = [
  <span
    key="ai"
    className="inline-flex items-center justify-center w-12 h-12 p-2 bg-white rounded-2xl shadow-md text-2xl z-10"
  >
    <svg 
...
>
  ...
  <span
    key="search"
    className="inline-flex items-center justify-center w-12 h-12 bg-white rounded-2xl p-2 shadow-md text-2xl z-10"
  >
   <svg
  fill="#000000"
  width="600px"
...
const PipelineSection = () => (
  <section className="w-full bg-[#0a0e23] py-16 sm:pt-36 sm:pb-20 px-2 sm:px-8">
    <div className="max-w-7xl mx-auto flex flex-col items-center">
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-medium text-center text-white mb-4 max-w-xl">
        Transform Your Sales Pipeline
      </h2>
      <p className="text-base  md:text-[16px] text-[#9ea3bf] text-center max-w-xs sm:max-w-3xl mb-10 sm:mb-16">
      ...
      <div className="w-full flex flex-col md:flex-row gap-5 items-center justify-center">
        {/* Left Card */}
        <div
          className="flex flex-col h-[420px] md:h-[560px] w-full max-w-[480px] bg-[#060a1e] border border-[#1c244c] rounded-[32px] shadow-2xl p-6 md:p-14 mx-auto mb-8 md:mb-0 justify-center items-center relative"
          style={{
            boxShadow:
        ...
        >
          <div className="w-full flex flex-col items-center mb-6">
            <h3 className="text-xl sm:text-2xl md:text-3xl font-medium text-white text-center mb-2">
              Find With Precision
            </h3>
            <p className=" text-center mt-3 mb-6 text-sm text-[#9ea3bf] ">
          ...
          <div className="flex-1 flex flex-col justify-center w-full">
            <div
              className="relative w-full bg-[#0a0e23] rounded-2xl shadow-lg p-5 flex flex-col justify-center overflow-hidden"
            ...
            >
              ...
              <div className="flex flex-col gap-2 z-10 w-full items-start">
                <div className="text-3xl sm:text-4xl font-medium text-white leading-none">
                  100%
                </div>
                <div className="text-[#9ea3bf]  text-sm  mb-4 mt-2">
                  Verified Leads
                </div>
                <div className="flex items-center gap-4 sm:gap-4 mb-3 relative">
        ...
        {/* Right Card */}
        <div
          className="flex flex-col h-[420px] md:h-[560px] w-full max-w-[480px] bg-[#060a1e] border border-[#1c244c] rounded-[32px] shadow-2xl p-6 md:p-14 mx-auto justify-center items-center relative"
          style={{
            boxShadow:
              "0 0 5px 0 #1c244c, inset 0 -10px 30px #1c244c",
          }}
        >
          <div className="w-full flex flex-col items-center mb-6">
            ...
            <p className=" text-center mb-6 text-sm mt-3 text-[#9ea3bf] ">
          ...
          <div className="flex-1 flex flex-col justify-center w-full">
            ...
            >
              ...
              <div className="flex flex-col gap-2 z-10 w-full items-start">
                ...
                <div className="text-[#9ea3bf]  text-sm mt-2 mb-3">
                  Optimized for Best Deliverability
                </div>
                <div className="flex flex-col gap-2 sm:gap-3 w-full max-w-xs">
                  <div className="flex items-center w-full">
                    <span className="inline-flex items-center gap-2 px-3 sm:px-5 py-2 sm:py-2 rounded-xl bg-[#181f36] border border-[#2a335c] text-white text-xs sm:text-base font-medium w-full justify-start shadow-sm">
                      <span className="text-lg sm:text-xl border border-[#2a335c] p-2 rounded-lg inline-flex items-center justify-center"><svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 fill-current" viewBox="0 0 64 64" fill="none">
  ...
  <path d="M48 43v10M43 48h10" stroke="#fff" stroke-width="3" stroke-linecap="round"/>
                  ...
                  <div className="flex items-center w-full">
                    <span className="inline-flex items-center gap-2 px-3 sm:px-5 py-2 sm:py-2 rounded-xl bg-[#181f36] border border-[#2a335c] text-white text-xs sm:text-base font-medium w-full justify-start shadow-sm">
                       <span className="text-lg sm:text-xl border border-[#2a335c] p-2 rounded-lg inline-flex items-center justify-center">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"

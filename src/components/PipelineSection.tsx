              ...
              <div className="flex flex-col gap-2 z-10 w-full items-start">
                ...
                <div className="flex flex-col gap-2 sm:gap-3 w-full max-w-xs">
                  <div className="flex items-center w-full">
                    <span className="inline-flex items-center gap-2 px-3 sm:px-5 py-2 sm:py-3 rounded-xl bg-[#181f36] border border-[#2a335c] text-white text-xs sm:text-base font-medium w-full justify-start shadow-sm">
